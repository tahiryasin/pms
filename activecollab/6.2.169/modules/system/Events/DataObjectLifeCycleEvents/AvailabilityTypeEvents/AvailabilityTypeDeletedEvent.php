...
class AvailabilityTypeDeletedEvent extends AvailabilityTypeLifeCycleEvent implements AvailabilityTypeDeletedEventInterface
{
    use DataObjectLifeCycleWebhookEventTrait;

    public function getWebhookEventType(): string
    {
        return 'AvailabilityTypeDeleted';
    }
}
