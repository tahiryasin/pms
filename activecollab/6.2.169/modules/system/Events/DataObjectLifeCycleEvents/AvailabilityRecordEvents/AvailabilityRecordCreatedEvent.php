...
class AvailabilityRecordCreatedEvent extends AvailabilityRecordLifeCycleEvent implements AvailabilityRecordCreatedEventInterface
{
    use DataObjectLifeCycleWebhookEventTrait;

    public function getWebhookEventType(): string
    {
        return 'AvailabilityRecordCreated';
    }
}
