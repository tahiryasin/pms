...
class AvailabilityRecordDeletedEvent extends AvailabilityRecordLifeCycleEvent implements AvailabilityRecordDeletedEventInterface
{
    use DataObjectLifeCycleWebhookEventTrait;

    public function getWebhookEventType(): string
    {
        return 'AvailabilityRecordUpdated';
    }
}
