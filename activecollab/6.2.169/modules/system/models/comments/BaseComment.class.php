 ...
 * @subpackage models
 */
abstract class BaseComment extends ApplicationObject implements IAttachments, IHistory, IActivityLog, ITrash, IWhoCanSeeThis, IReactions, ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface, IChild, IBody, ICreatedOn, ICreatedBy, IUpdatedOn, IUpdatedBy
{
    const MODEL_NAME = 'Comment';
    const MANAGER_NAME = 'Comments';
     ...
     * @var array
     */
    protected $fields = ['id', 'source', 'parent_type', 'parent_id', 'body', 'ip_address', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'is_trashed', 'original_is_trashed', 'trashed_on', 'trashed_by_id'];
     ...
     * @var array
     */
    protected $default_field_values = ['is_trashed' => false, 'original_is_trashed' => false, 'trashed_by_id' => 0];
