...
abstract class BaseCompanies extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'name', 'address', 'homepage_url', 'phone', 'note', 'currency_id', 'tax_id', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'is_archived', 'archived_on', 'is_trashed', 'trashed_on', 'trashed_by_id', 'is_owner'];
