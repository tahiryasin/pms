...
abstract class BaseUploadedFiles extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'type', 'name', 'mime_type', 'size', 'location', 'md5', 'code', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'ip_address', 'raw_additional_properties'];
