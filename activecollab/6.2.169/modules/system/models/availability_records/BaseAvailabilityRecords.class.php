...
abstract class BaseAvailabilityRecords extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'availability_type_id', 'user_id', 'message', 'start_date', 'end_date', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on'];
