...
abstract class BaseStopwatches extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'parent_type', 'parent_id', 'user_id', 'user_name', 'user_email', 'started_on', 'is_kept', 'elapsed', 'created_on', 'updated_on', 'notification_sent_at'];
