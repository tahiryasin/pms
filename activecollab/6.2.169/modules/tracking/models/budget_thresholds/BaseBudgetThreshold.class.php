...
/**
 * BaseBudgetThreshold class.
 *
 * @package ActiveCollab.modules.tracking
 * @subpackage models
 */
abstract class BaseBudgetThreshold extends ApplicationObject implements ICreatedOn, ICreatedBy
{
     ...
     * @var string
     */
    protected $table_name = 'budget_thresholds';
     ...
     * @var array
     */
    protected $fields = ['id', 'project_id', 'type', 'threshold', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email'];
     ...
     * @var array
     */
    protected $default_field_values = ['project_id' => 0, 'threshold' => 0];
