...
class TimerIntegration extends Integration
{
    ...
    {
        return ConfigOptions::setValue('minimal_time_entry', (int) $value);
    }
    ...
    {
        return ConfigOptions::setValue('rounding_interval', (int) $value);
    }
    ...
    {
        $minTimeEntry = ConfigOptions::getValue('minimal_time_entry');

        return !is_null($minTimeEntry) ? $minTimeEntry : 15;
    }
    ...
    {
        $roundingInterval = ConfigOptions::getValue('rounding_interval');

        return !is_null($roundingInterval) ? $roundingInterval : 15;
    }
