...
abstract class BaseTimeRecords extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'parent_type', 'parent_id', 'invoice_item_id', 'job_type_id', 'record_date', 'value', 'user_id', 'user_name', 'user_email', 'summary', 'billable_status', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'is_trashed', 'original_is_trashed', 'trashed_on', 'trashed_by_id', 'source', 'internal_rate', 'job_type_hourly_rate'];
