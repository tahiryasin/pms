...
abstract class BaseRemoteInvoice extends ApplicationObject implements IUpdatedOn, IUpdatedBy, IAdditionalProperties
{
     ...
     * @var array
     */
    protected $fields = ['id', 'type', 'invoice_number', 'client', 'remote_code', 'amount', 'balance', 'based_on', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'raw_additional_properties'];
     ...
     * @var array
     */
    protected $default_field_values = ['amount' => 0.0, 'balance' => 0.0, 'based_on' => 'time_and_expenses'];
