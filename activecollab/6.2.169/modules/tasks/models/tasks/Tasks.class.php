...
class Tasks extends BaseTasks
{
    ...
    public static function countOpenByTaskList(TaskList $task_list, bool $use_cache = false): int
    {
    ...
    public static function countCompletedByTaskList(TaskList $task_list, bool $use_cache = false): int
    {
        return (int) AngieApplication::cache()->getByObject(
            $task_list,
