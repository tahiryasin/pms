...
abstract class BaseTask extends ApplicationObject implements IAssignees, IComplete, IHistory, IAccessLog, ISubscriptions, IIncomingMail, IComments, IAttachments, ILabels, ITrash, \Angie\Search\SearchItem\SearchItemInterface, IActivityLog, IReminders, IHiddenFromClients, ITaskDependencies, IWhoCanSeeThis, IProjectElement, ITracking, IInvoiceBasedOn, IBody, ICreatedOn, ICreatedBy, IUpdatedOn, IUpdatedBy
{
     ...
     * @var array
     */
    protected $fields = ['id', 'project_id', 'task_number', 'task_list_id', 'assignee_id', 'delegated_by_id', 'created_from_recurring_task_id', 'name', 'body', 'is_important', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'start_on', 'due_on', 'job_type_id', 'estimate', 'completed_on', 'completed_by_id', 'completed_by_name', 'completed_by_email', 'position', 'is_hidden_from_clients', 'is_billable', 'is_trashed', 'original_is_trashed', 'trashed_on', 'trashed_by_id', 'fake_assignee_name', 'fake_assignee_email'];
     ...
     * @var array
     */
    protected $default_field_values = ['project_id' => 0, 'task_number' => 0, 'task_list_id' => 0, 'assignee_id' => 0, 'delegated_by_id' => 0, 'created_from_recurring_task_id' => 0, 'name' => '', 'is_important' => false, 'job_type_id' => 0, 'estimate' => 0.0, 'position' => 0, 'is_hidden_from_clients' => false, 'is_billable' => true, 'is_trashed' => false, 'original_is_trashed' => false, 'trashed_by_id' => 0];
