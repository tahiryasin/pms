...
class DiskSpaceSystemNotification extends SystemNotification
{
    ...
    {
        return lang(
            "You've used up more storage than your subscription allows (:space). Please switch to a larger plan to be able to upload new files.", [
            'space' => defined('ON_DEMAND_PLAN_MAX_DISK_SPACE')
                ? format_file_size(ON_DEMAND_PLAN_MAX_DISK_SPACE)
                : format_file_size(0),
            ]
        );
    }
