...
abstract class BaseUserInvitations extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'user_id', 'invited_to_type', 'invited_to_id', 'code', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on'];
