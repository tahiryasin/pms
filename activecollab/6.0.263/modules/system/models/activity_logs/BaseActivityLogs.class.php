...
abstract class BaseActivityLogs extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'type', 'parent_type', 'parent_id', 'parent_path', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'raw_additional_properties'];
