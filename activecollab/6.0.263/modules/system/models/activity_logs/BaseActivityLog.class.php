 ...
 * @subpackage models
 */
abstract class BaseActivityLog extends ApplicationObject implements ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface, IChild, ICreatedOn, ICreatedBy, IUpdatedOn, IAdditionalProperties
{
    use IChildImplementation, ICreatedOnImplementation, ICreatedByImplementation, IUpdatedOnImplementation, IAdditionalPropertiesImplementation;
     ...
     * @var array
     */
    protected $fields = ['id', 'type', 'parent_type', 'parent_id', 'parent_path', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'raw_additional_properties'];
     ...
     * @var array
     */
    protected $default_field_values = ['parent_path' => ''];
