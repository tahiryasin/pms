 ...
 * @subpackage models
 */
abstract class BaseDayOff extends ApplicationObject implements ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface
{
     ...
     * @var array
     */
    protected $fields = ['id', 'name', 'start_date', 'end_date', 'repeat_yearly'];
