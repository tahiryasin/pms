...
{
    use IWhoCanSeeThisImplementation, IChildImplementation, ICreatedOnImplementation, ICreatedByImplementation;
     ...
     * @var array
     */
    protected $fields = ['id', 'type', 'parent_type', 'parent_id', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email'];
