 ...
 * @subpackage models
 */
abstract class BaseTimeRecord extends ApplicationObject implements ITrash, IHistory, IActivityLog, ITrackingObject, ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface, IChild, ICreatedOn, ICreatedBy, IUpdatedOn, IUpdatedBy
{
     ...
     * @var array
     */
    protected $fields = ['id', 'parent_type', 'parent_id', 'invoice_item_id', 'job_type_id', 'record_date', 'value', 'user_id', 'user_name', 'user_email', 'summary', 'billable_status', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'is_trashed', 'original_is_trashed', 'trashed_on', 'trashed_by_id', 'source'];
     ...
     * @var array
     */
    protected $default_field_values = ['invoice_item_id' => 0, 'job_type_id' => 0, 'billable_status' => 0, 'is_trashed' => false, 'original_is_trashed' => false, 'trashed_by_id' => 0, 'source' => 'unknown'];
