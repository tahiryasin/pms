...
{
    use ICreatedOnImplementation, IUpdatedOnImplementation, IWhoCanSeeThisImplementation, IChildImplementation;
     ...
     * @var array
     */
    protected $fields = ['id', 'parent_type', 'parent_id', 'user_id', 'user_name', 'user_email', 'started_on', 'is_kept', 'elapsed', 'created_on', 'updated_on'];
