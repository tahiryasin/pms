...
function smarty_function_notification_invoice_items_table($params, &$smarty)
{
    ...
    if ($items) {
        foreach ($items as $item) {
            ...
            $content .= '<td style="padding: 2px;">' . nl2br(clean($item->getDescription())) . '</td>';
            ...
            } elseif ($invoice_template->getDisplayTaxAmount()) {
    ...
    $content .= '<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 36px;" bgcolor="#ffffff" width="100%">
        ...
        <tr>
          ...
          <td style="padding: 2px; width: 56px; text-align: right; font-weight: bold; border-bottom: 1px solid #eee;">' . $invoice_currency->format($context->getRoundedTotal()) . '</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 2px; width: 56px; text-align: right; font-weight: bold; border-bottom: 1px solid #eee;">' . $context->getCurrency()->getCode() . ' ' . $invoice_currency->format($context->getBalanceDue()) . '</td>
        </tr>
      </table>';
