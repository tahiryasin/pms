...
abstract class BaseRemoteInvoices extends DataManager
{
     ...
     * @var array
     */
    private static $fields = ['id', 'type', 'invoice_number', 'client', 'remote_code', 'amount', 'balance', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'raw_additional_properties'];
