...
{
    use ISubscriptionsImplementation, ICommentsImplementation, IAttachmentsImplementation, IHistoryImplementation, IAccessLogImplementation, \Angie\Search\SearchItem\Implementation, ITrashImplementation, IActivityLogImplementation, IProjectElementImplementation, ActiveCollab\Foundation\Urls\Router\Context\RoutingContextImplementation, IBodyImplementation, ICreatedOnImplementation, ICreatedByImplementation, IUpdatedOnImplementation, IUpdatedByImplementation {
     ...
     * @var string
     */
    protected $table_name = 'discussions';
     ...
     * @var array
     */
    protected $fields = ['id', 'project_id', 'name', 'body', 'created_on', 'created_by_id', 'created_by_name', 'created_by_email', 'updated_on', 'updated_by_id', 'updated_by_name', 'updated_by_email', 'is_hidden_from_clients', 'is_trashed', 'original_is_trashed', 'trashed_on', 'trashed_by_id'];
     ...
     * @var array
     */
    protected $default_field_values = ['project_id' => 0, 'name' => '', 'is_hidden_from_clients' => false, 'is_trashed' => false, 'original_is_trashed' => false, 'trashed_by_id' => 0];
