[{$project->getName()}] {lang name=$subtask->getName()|excerpt language=$language}':name' Subtask Created{/lang}
================================================================================
<!-- Message Body -->
<h1 style="font-size: 16px; font-weight: bold; margin-top: 20px; margin-bottom: 16px;">
    {if $recipient instanceof User && $subtask->isAssignee($recipient)}
        {lang author=$subtask->getCreatedBy()->getDisplayName() language=$language}:author assigned you the subtask:{/lang} &#10065;
        <br/>
    {else}
        {lang author=$subtask->getCreatedBy()->getDisplayName() language=$language}:author created the subtask:{/lang} &#10065;
        <br/>
    {/if}
