...
{
    use IAssigneesImplementation, ICompleteImplementation, IHistoryImplementation, IAccessLogImplementation, ISubscriptionsImplementation, ICommentsImplementation, IAttachmentsImplementation, ILabelsImplementation, ITrashImplementation, \Angie\Search\SearchItem\Implementation, IActivityLogImplementation, IRemindersImplementation, ITaskDependenciesImplementation, IWhoCanSeeThisImplementation, IProjectElementImplementation, ITrackingImplementation, IInvoiceBasedOnTrackedDataImplementation, IBodyImplementation, ICreatedOnImplementation, ICreatedByImplementation, IUpdatedOnImplementation, IUpdatedByImplementation {
     ...
     * @var array
     */
    protected $default_field_values = ['project_id' => 0, 'task_number' => 0, 'task_list_id' => 0, 'assignee_id' => 0, 'delegated_by_id' => 0, 'created_from_recurring_task_id' => 0, 'name' => '', 'is_important' => false, 'job_type_id' => 0, 'estimate' => 0.0, 'position' => 0, 'is_hidden_from_clients' => false, 'is_trashed' => false, 'original_is_trashed' => false, 'trashed_by_id' => 0];
