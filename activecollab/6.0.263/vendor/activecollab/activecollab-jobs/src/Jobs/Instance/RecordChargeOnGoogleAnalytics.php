...
//        try{
//            $google_client_response = (new UsersApi(
//                $this->getShepherdClient($this->getData()),
//                $this->getUrlCreator($this->getData())
//            ))->getUserGoogleClientId($account_id, $this->getData('user_account_id'));
