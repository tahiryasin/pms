    ...
    public function defineClasses()
    {
        AngieApplication::setForAutoload(
            [
                ...
                FwLanguage::class => __DIR__ . '/models/languages/FwLanguage.class.php',
                FwLanguages::class => __DIR__ . '/models/languages/FwLanguages.class.php',
                ...
                FwSystemNotification::class => __DIR__ . '/models/system_notifications/FwSystemNotification.class.php',
                FwSystemNotifications::class => __DIR__ . '/models/system_notifications/FwSystemNotifications.class.php',
